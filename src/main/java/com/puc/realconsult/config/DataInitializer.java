...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        // Sempre garantir que usuários padrões existam
        if (!repository.existsByEmail("adm@vtreal.com.br")) {
        ...
        if (!repository.existsByEmail("gerente@vtreal.com.br")) {
            UserModel usuario2 = new UserModel();
            usuario2.setNome("Teste Gerente");
            usuario2.setCargo("Gerente");
            usuario2.setEmail("gerente@vtreal.com.br");
        ...
        if (!repository.existsByEmail("analista@vtreal.com.br")) {
            UserModel usuario3 = new UserModel();
            usuario3.setNome("Teste Analista");
            usuario3.setCargo("Analista");
            usuario3.setEmail("analista@vtreal.com.br");
